$(function(){
	...
	var predefinedMapMarkers = [
		{ value: 'default-p', name: 'Marcador por defecto'},
		{ value: 'pin-export-p', name: 'Pin'},
		{ value: 'star-3-p', name: 'Punto de interes'},
		{ value: 'start-race-2-p', name: 'Largada'},
		{ value: 'finish-p', name: 'Meta'},
		{ value: 'flag-export-p', name: 'Bandera'},

		{ value: 'car-p', name: 'Auto'},
		{ value: 'cruiseship-p', name: 'Barco'},
		{ value: 'ferry-p', name: 'Ferry'},
		{ value: 'train-p', name: 'Tren'},
		{ value: 'tramway-p', name: 'Tranvia'},
		{ value: 'busstop-p', name: 'Colectivo'},
		{ value: 'airport-p', name: 'Aeropuerto'},

		{ value: 'travel_agency-p', name: 'Viaje'},

		{ value: 'lodging-2-p', name: 'Alojamiento'},

		{ value: 'fillingstation-p', name: 'Estacion de servicio'},
		{ value: 'oil-2-p', name: 'Servicios'},
		{ value: 'repair-p', name: 'Servicios 2'},

		{ value: 'campfire-2-p', name: 'Fogata'},
		{ value: 'camping-2-p', name: 'Camping'},
		{ value: 'kayak1-p', name: 'Kayak'},
		{ value: 'walkingtour-p', name: 'Caminata'},
		{ value: 'fishing-p', name: 'Pesca'},
		{ value: 'photo-p', name: 'Punto panoramico'},
		{ value: 'beautifulview-p', name: 'Punto panoramico 2'},
		{ value: 'waterfall-2-p', name: 'Cascada'},
		{ value: 'volcano-2-p', name: 'Volcan'},
		{ value: 'palm-tree-export-p', name: 'Playa'},

		{ value: 'caution-p', name: 'Precaucion'},
		{ value: 'information-p', name: 'Informacion'},
		{ value: 'firstaid-p', name: 'Salud 1'},
		{ value: 'ambulance-p', name: 'Salud 2'},

		{ value: 'theater-p', name: 'Teatro'},
		{ value: 'themepark-p', name: 'Parque de atracciones'},
		{ value: 'aquarium-p', name: 'Acuario'},
		{ value: 'casino-2-p', name: 'Casino'},
		{ value: 'museum_art', name: 'Museo'},
		{ value: 'art-museum-2-p', name: 'Museo 2'},
		{ value: 'museum_crafts-p', name: 'Historia'},
		{ value: 'museum_war-p', name: 'Historia 2'},
		{ value: 'chapel-2-p', name: 'Iglesia'},
		{ value: 'cow-export-p', name: 'Granja'},
		{ value: 'giraffe-p', name: 'Zoo'},
		{ value: 'zoo-p', name: 'Zoo 2'},
		{ value: 'harbor-p', name: 'Puerto'},
		{ value: 'drink-p', name: 'Bebida'},
		{ value: 'burger-p', name: 'Comida'},
		{ value: 'supermarket-p', name: 'Mercado'},
		{ value: 'congress-p', name: 'Gobierno'},
		{ value: 'postal-p', name: 'Correo'},
		{ value: 'castle-2-p', name: 'Castillo'},
		{ value: 'parkinggarage-p', name: 'Parking'},
		{ value: 'poker-p', name: 'Cartas'},
		{ value: 'shintoshrine-p', name: 'Atraccion'},
		{ value: 'smallcity-p', name: 'Ciudad'},
		{ value: 'tree-p', name: 'Arbol'},
		{ value: 'alligator-p', name: 'Cocodrilo'}
	];
